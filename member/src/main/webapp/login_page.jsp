...
<body>
	...
	<img src="/member/images/yju_com_01.jpg" />

	<ul>
		<li><a href="/member/mem_views/member01.jsp?mem_id=<%=session.getAttribute("userid")%>">회원관리페이지01</a> <!--세션에 저장된 id 값을 넘겨주면서 이동-->
		<li><a href="/member/mem_views/member02.jsp?mem_id=<%=session.getAttribute("userid")%>">회원관리페이지02</a> <!--세션에 저장된 id 값을 넘겨주면서 이동-->
